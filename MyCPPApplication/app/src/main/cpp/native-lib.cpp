...
JNIEXPORT jstring JNICALL
Java_com_example_mycppapplication_MainActivity_sendYourName(JNIEnv *env, jobject thiz,
...
Java_com_example_mycppapplication_MainActivity_stringArrayFromJNI(JNIEnv *env, jobject thiz) {
